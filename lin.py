...
def pinglu(key):
    ...
    for sss in ss['posts']:
        print(sss['postID'])
        shiz+=1
        dfghj = random.choice(['楼主有兴趣参加玩机版块，玩机部门吗，每月发发帖子就有葫芦哦[吐舌][滑稽]','楼主有兴趣参加玩机版块，玩机部门吗，每月发发帖子就有葫芦哦[滑稽]','楼主有兴趣参加玩机版块，玩机部门吗，每月发发帖子就有葫芦哦[滑稽]','楼主有兴趣参加玩机版块，玩机部门吗，每月发发帖子就有葫芦哦！','楼主有兴趣参加玩机版块，玩机部门吗，每月发发帖子就有葫芦哦！'])
        dfg = f'{dfghj}{shiz}'
        post_id = sss['postID']
        print(dfg)
